...
`python Prog_CAE.py [-p1 OMIC1] [-p2 OMIC2] [-p3 OMIC3] [-p4 OMIC4] [-p5 Survive]`<br>
...
Example
-----
Taking the example data as an example, after you have downloaded the project file, the usage is as follows:
